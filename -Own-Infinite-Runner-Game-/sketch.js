...
rocket.setCollider("circle" ,0,0,100);
  rocket.debug = true;
   ...
   gameover = createSprite(200,150,300,100);
  ...
  gameover.visible = true;
   ...
   button = createSprite(200,200,300,100);
...
if(World.frameCount % 100 === 0){
  ...
  if(World.frameCount % 190 === 0){
   ...
   if (gameState === END){
    ...
    aleinGroup.setVelocityXEach(0);
    aleinGroup.setLifetimeEach(-1);
